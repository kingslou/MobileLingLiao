...
import com.cyt.ieasy.model.SerializableMap;
 ...
 */
public class AddotherWuZiActivity extends BaseActivity {
    @Bind(R.id.toolbar)
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!CommonTool.isWifiOK(AddotherWuZiActivity.this)){
    ...
    public void onEvent(MessageEvent event) {
        ...
        if(event.message.equals(Const.Success)){
            ...
            EmportyUtils.createFailView(AddotherWuZiActivity.this);
        }
    }
...
//                initAdapter(wuZiTableList);
    ...
    protected void onStart() {
        super.onStart();
        EventBus.getDefault().register(AddotherWuZiActivity.this);
    }

    @Override
    protected void onStop() {
        super.onStop();
        EventBus.getDefault().unregister(AddotherWuZiActivity.this);
    }
}
